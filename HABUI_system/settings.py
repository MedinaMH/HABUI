"""
Django settings for HABUI_system project.
...
SECRET_KEY = 'django-insecure-jklk#cv+k+od&-@usci)2e2&e)6n*9)s%^98grkd%fal#pem!b'
...
ROOT_URLCONF = 'HABUI_system.urls'
...
WSGI_APPLICATION = 'HABUI_system.wsgi.application'
